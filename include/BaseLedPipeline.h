...
//   - called on an rvalue (a temporary chain): returns Builder    by moving *this out, so `auto b = X::Builder(..).f(..)`
...
#define BUILDER_FIELD(type, field)											\
    ...
    Builder field(type v) && { this->_##field = v; return std::move(*this); }
